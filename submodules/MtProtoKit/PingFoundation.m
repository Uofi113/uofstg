...
@property (nonatomic, strong, readwrite, ) CFHostRef host __attribute__ ((NSObject));

/*! A socket object for ICMP send and receive.
 */

@property (nonatomic, strong, readwrite, ) CFSocketRef socket __attribute__ ((NSObject));
