...
- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    ...
    TGLog(@"IOS6CALL phone_phoneCall.baseFallback phone_call=%@ users=%d", object.phone_call, (int)object.users.count);
    return object;
}
...
- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.phone_call = metaObject->getObject((int32_t)0x77bcd691);
    object.users = metaObject->getArray((int32_t)0x933e5ff3);
    TGLog(@"IOS6CALL phone_phoneCall.parsed phone_call=%@ users=%d", object.phone_call, (int)object.users.count);
    return object;
}
