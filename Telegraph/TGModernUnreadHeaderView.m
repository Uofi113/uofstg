...
+ (void)drawHeaderForContainerWidth:(CGFloat)containerWidth inContext:(CGContextRef)context andBindBackgroundToContainer:(UIView *)backgroundContainer atPosition:(CGPoint)position presentation:(TGPresentation *)presentation
{
    ...
    UIImage *backgroundImage = TGClassicIOS6UnreadHeaderBackgroundImage();
    ...
    UIFont *effectiveFont = classicFont;
    ...
    CGContextSetFillColorWithColor(context, (TGClassicIOS6UnreadHeaderTextColor()).CGColor);
...
- (id)initWithFrame:(CGRect)frame presentation:(TGPresentation *)presentation
{
    ...
    if (self)
    {
        ...
        bool classicIOS6Style = true;
        _backgroundView = [[UIImageView alloc] initWithImage:TGClassicIOS6UnreadHeaderBackgroundImage()];
        [self addSubview:_backgroundView];
        
        _labelView = [[UILabel alloc] init];
        _labelView.backgroundColor = [UIColor clearColor];
        _labelView.textColor = TGClassicIOS6UnreadHeaderTextColor();
        _labelView.font = TGBoldSystemFontOfSize(13.0f);
        _labelView.shadowColor = UIColorRGBA(0xffffff, 0.9f);
...
{
    bool classicIOS6Style = true;
    _backgroundView.image = TGClassicIOS6UnreadHeaderBackgroundImage();
    _labelView.textColor = TGClassicIOS6UnreadHeaderTextColor();
    _labelView.font = TGBoldSystemFontOfSize(13.0f);
    _labelView.shadowColor = UIColorRGBA(0xffffff, 0.9f);
