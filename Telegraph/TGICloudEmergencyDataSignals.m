...
+ (SSignal *)fetchBackupAddressInfo:(NSString *)__unused prefix phoneNumber:(NSString *)__unused phoneNumber
{
...
+ (void)processNotification:(CKNotification *)__unused notification
{
}
