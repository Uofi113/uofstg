...
- (instancetype)initWithForm:(TGPassportForm *)form values:(NSArray *)values
{
...
- (instancetype)updateWithValues:(NSArray *)values removeValueTypes:(NSArray *)removeValueTypes
{
